/**
 * Shared toast type → icon + color metadata (copied from llmaixweb).
 * A single source of truth for the visual treatment of each toast variant,
 * so `ToastItem` stays declarative. Icons come from `@lucide/vue`.
 */
